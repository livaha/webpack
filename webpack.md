...
> 2018年11月29日更新，目前 webpack 已经更新值 4.26.1 ，本文所用到的各种库或多或少有些过时，跟着代码操作下来可能会遇到各种问题，不过 webpack 的主体思想没变，所以还是希望本文对新学 webpack 的你，有所帮助。此外用基于 webpack 4.26.1 [写了一个简单的demo，如果遇到啥问题，可以参考](https://github.com/Val-Zhang/webpack-demo-client)，之后应该会逐步来完善这个demo，如果有啥通用的想实现的功能，也可以在里面提 issue。
...
![img](assets/1031000-d0693c06bb3a00e3.png)
...
![img](assets/1031000-160bc667d3b6093a.png)
...
![img](assets/1031000-976ba1a06fd0702f.png)
...
```
  ...
  会自动打包到dist/main.js中，此时index.js中包含的bundle.js改为../dist/main.js即可出现同样效果。:

可以看出`webpack`同时编译了`main.js` 和`Greeter,js`,现在打开`index.html`,可以看到如下结果

![img](assets/1031000-6cf1ecc41ef8c31d.png)
...
![img](assets/1031000-a3e10146ffac4163.png) 
...
现在只需要使用`npm start`就可以打包文件了，有没有觉得`webpack`也不过如此嘛，不过不要太小瞧`webpack`，要充分发挥其强大的功能我们需要修改配置文件的其它选项，一项项来看。
 ...
 改：因为我这里的执行目录与node_modules不在同一个目录，所以，应当在当前执行目录（与webpack.config.js同一目录）加一个package.json文件，

我的目录:

 ![1543457698574](assets/1543457698574.png)
...
![img](assets/1031000-47d5bea9ef177187.png) 
...
【1】 vue-template-compiler：这个用于把 Vue 的模板文件（应该指.vue）预编译为渲染函数，避免运行时再编译带来的性能开销。
...
![1543469094002](assets/1543469094002.png)
...
![img](assets/1031000-61f802a003991423.png) 
...
![img](upload-images.jianshu.io/upload_images/1031000-9d190ecceaeb9e0e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/462/format/webp)
...
参考 官网 ：https://webpack.docschina.org/loaders/babel-loader/
...
![1543480150235](assets/1543480150235.png)



![1543480456322](assets/1543480456322.png)
...
![img](assets/1031000-7d2a7769709a2e36.png) 
...
![img](assets/1031000-f9b89ce486539162.png) 
...
![img](assets/1031000-2441bb1e9f8f5908.png) 
...
欢迎大家在文后发表自己的观点讨论。
 ...
 摘自（有改动）：https://www.jianshu.com/p/42e11515c10f
